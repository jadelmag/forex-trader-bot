...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        if command == 'test':
            ...
            print("  - test_candle_strategies.py")
            print("  - verify_candle_strategies.py")
            print("  - test_strategies.py")
            print("  - test_candle_strategies_comprehensive.py")
            print("  - test_candlestick_patterns.py")
            print()
